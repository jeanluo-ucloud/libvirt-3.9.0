...
static int vhost_user_set_recovery_fd(struct vhost_dev *dev,
                                struct vhost_vring_file *file)
{
    int fds[VHOST_MEMORY_MAX_NREGIONS];
    size_t fd_num = 0;
    VhostUserMsg msg = {
        .hdr.request = VHOST_USER_SET_RECOVERY_FD,
        .hdr.flags = VHOST_USER_VERSION,
...
const VhostOps user_ops = {
        ...
        .vhost_set_recovery_fd = vhost_user_set_recovery_fd,
};
